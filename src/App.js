...
class App extends Component {
  ...
  getArticlesFromSever() {
    ...
    return [sample_short, sample_short, sample_short, sample_middle,sample_middle, sample_middle, sample_middle, sample_long, sample_long];
  }
}
